      ...
      <div className="ai-settings-grid">
        ...
        <div className="ai-setting-block">
          ...
          <div className="ai-form-grid compact">
            ...
            <label><span>英语等级</span><select value={settings.defaultEnglishLevel} onChange={(event) => updateSettings({ defaultEnglishLevel: event.target.value as typeof settings.defaultEnglishLevel })}><option>四级</option><option>六级</option><option>TOEIC</option></select></label>
