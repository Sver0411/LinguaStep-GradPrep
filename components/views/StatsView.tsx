...
export function StatsView() {
  const { snapshot, allWords } = useLearning();
  ...
  return (
    <div className="page-stack stats-page">
      <PageHeader
        eyebrow="学习统计"
        title="只看真正有用的学习进度"
        description="保留今日完成量、连续学习、单词掌握、待复习与错题等核心信息。"
      ...
      <section className="distribution-section">
        ...
        <div className="distribution-grid compact-distribution"><DistributionChart title={`单词 · ${mode === "combined" ? "日英对照" : mode === "japanese" ? "日语" : "英语"}`} values={wordDistribution} /></div>
      </section>
