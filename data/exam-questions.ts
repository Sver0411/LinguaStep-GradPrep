...
const JAPANESE_BOOK_QUESTIONS: ExamQuestion[] = [
  japaneseQuestion("char-001", "N3", "characters", "お店の前に人が〔並んで〕います。下線部の読み方として最もよいものを選びなさい。", ["あそんで", "ならんで", "はさんで", "さけんで"], 1, "「並んで」は「ならんで」と読む。"),
  japaneseQuestion("char-002", "N3", "characters", "日本は〔物価〕が高いと言われている。下線部の読み方として最もよいものを選びなさい。", ["ぶつか", "もつか", "ぶっか", "もっか"], 2, "「物価」は「ぶっか」と読み、商品やサービスの価格水準を表す。"),
  ...
  japaneseQuestion("char-001", "N2", "characters", "日本では野球選手に〔憧れる〕子どもたちが多い。下線部の読み方として最もよいものを選びなさい。", ["あこがれる", "みだれる", "めぐまれる", "たおれる"], 0, "「憧れる」は「あこがれる」と読む。"),
  japaneseQuestion("char-002", "N2", "characters", "最近、〔化粧〕をする男性が増えている。下線部の読み方として最もよいものを選びなさい。", ["かしょう", "かっしょう", "けしょう", "けっしょう"], 2, "「化粧」は「けしょう」と読む。"),
  ...
  japaneseQuestion("char-001", "N1", "characters", "エレベーターの点検を〔怠った〕ため、事故を引き起こした。下線部の読み方として最もよいものを選びなさい。", ["おこたった", "そなわった", "さえぎった", "あなどった"], 0, "「怠る」は「おこたる」と読み、するべきことをしない意味。"),
  japaneseQuestion("char-002", "N1", "characters", "この仕事の応募には、スペイン語が〔必須〕条件となっている。下線部の読み方として最もよいものを選びなさい。", ["ひっしゅう", "ひっす", "ひっしゅ", "ひつじゅ"], 1, "「必須」は「ひっす」と読む。"),
...
const JAPANESE_EXTRA_QUESTIONS: ExamQuestion[] = [
  ...
  japaneseQuestion("extra-char-02", "N3", "characters", "〔改札口〕で切符を見せてください。下線部の読み方として最もよいものを選びなさい。", ["かいさつぐち", "かいせつぐち", "かいさつこう", "かいせつこう"], 0, "「改札口」は「かいさつぐち」と読む。"),
  japaneseQuestion("extra-char-03", "N3", "characters", "この色はあなたの服によく（　）。", ["似合う", "違う", "戻る", "触る"], 0, "服や色が人に「似合う」は、よく調和するという意味。"),
  japaneseQuestion("extra-char-04", "N3", "characters", "説明が〔細かすぎて〕、かえって分かりにくい。下線部の読み方はどれですか。", ["こまかすぎて", "ほそかすぎて", "さいかすぎて", "ちいさすぎて"], 0, "「細かい」は「こまかい」と読む。"),
  ...
  japaneseQuestion("extra-char-02", "N2", "characters", "災害に〔備えて〕、水を用意しておく。下線部の読み方はどれですか。", ["そなえて", "たくわえて", "そろえて", "ささえて"], 0, "「備える」は「そなえる」と読む。"),
  japaneseQuestion("extra-char-03", "N2", "characters", "新しい社員を〔採用〕する予定です。下線部の読み方はどれですか。", ["さいよう", "さいゆう", "さいおう", "さよう"], 0, "「採用」は「さいよう」と読む。"),
  japaneseQuestion("extra-char-04", "N2", "characters", "無駄な表現を〔省いて〕、文章を短くした。下線部の読み方として最もよいものを選びなさい。", ["はぶいて", "ぬいて", "のぞいて", "かわいて"], 0, "「省く」は「はぶく」と読む。"),
  ...
  japaneseQuestion("extra-char-01", "N1", "characters", "制度の変更は社会に〔著しい〕影響を与えた。下線部の読み方はどれですか。", ["いちじるしい", "いちじるしゅい", "ちょじるしい", "いちろしい"], 0, "「著しい」は「いちじるしい」と読む。"),
  japaneseQuestion("extra-char-02", "N1", "characters", "彼は長年、環境政策に〔携わって〕きた。下線部の読み方はどれですか。", ["たずさわって", "たずねわって", "かかわって", "たおわって"], 0, "「携わる」は「たずさわる」と読む。"),
  japaneseQuestion("extra-char-03", "N1", "characters", "似た名前の制度が多く、非常に〔紛らわしい〕。下線部の読み方として最もよいものを選びなさい。", ["まぎらわしい", "まぎわらしい", "ふんらわしい", "まくらわしい"], 0, "「紛らわしい」は「まぎらわしい」と読む。"),
  japaneseQuestion("extra-char-04", "N1", "characters", "交渉によって対立を〔打開〕する道が見えた。下線部の読み方として最もよいものを選びなさい。", ["だかいする", "たかいする", "うちひらく", "しょうがいする"], 0, "「打開する」は「だかいする」と読み、困難を切り開く意味。"),
  japaneseQuestion("extra-grammar-01", "N1", "grammar", "会社は計画の見直し（　）。", ["を余儀なくされた", "を余儀にされた", "に余儀をされた", "を余儀なくした"], 0, "「～を余儀なくされる」は、望まなくてもそうせざるを得ないこと。"),
  japaneseQuestion("extra-grammar-02", "N1", "grammar", "去年の好況（　）、今年は景気が停滞している。", ["にひきかえ", "にかかわらず", "をものともせず", "に先立って"], 0, "「～にひきかえ」は、二つの事柄を対比する。"),
  japaneseQuestion("extra-grammar-03", "N1", "grammar", "その映画を見ると、涙を流さ（　）。", ["ずにはいられない", "ないではおかない", "ないことはない", "ずにすむ"], 0, "「～ずにはいられない」は、気持ちを抑えられず必ずしてしまうこと。"),
  japaneseQuestion("extra-grammar-04", "N1", "grammar", "彼は批判（　）、改革を進めた。", ["をものともせず", "をものにせず", "ものならず", "ものでもなく"], 0, "「～をものともせず」は、困難を恐れずに行動すること。"),
